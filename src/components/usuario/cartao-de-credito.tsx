import './cartao-de-credito.css';
import { useState } from 'react';
interface setAtivandoCartaoProps {
    setAtivandoCartao: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function CartaoDeCredito({setAtivandoCartao}: setAtivandoCartaoProps) {
    const [validade, setValidade] = useState<string>("");
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const input = e.target.value;

        // Remove tudo que NÃO for número, mas mantém a barra
        let cleaned = input.replace(/[^\d]/g, "");

        // Limita a 4 números (MMYY)
        if (cleaned.length > 4) {
        cleaned = cleaned.slice(0, 4);
        }

        // Formata: adiciona a barra depois de 2 números
    ...
    return (
        ...
        <form className="form">
            ...
            <div className="input_container">
                <label className="input_label" htmlFor="password_field">Número do Cartão</label>
                <input
            ...
            <button onClick={() => setAtivandoCartao(false)} className="purchase--btn">Salvar Cartão</button>
            <div className="separator">
                <hr className="line" />
                <p>ou adicione outros métodos de pagamento</p>
                <hr className="line" />
            </div>
