    ...
    return (
      <>
        ...
        >
          ...
          <p className={`${adOpen && 'hidden'} absolute text-[0.7em] bottom-[1%] min-w-full text-center text-neutral-100`}>Sujeito à disponibilidade. Consulte condições</p>

          <div style={{padding: '4px 10px'}} className={`${adOpen && 'hidden'} absolute top-[3%] right-[4%] rounded-md bg-amber-400 text-sm text-slate-800`}>
            40% off
          </div>

          <div style={{padding: '4px 4px'}} className={`${adOpen && 'hidden'} absolute top-[75%] right-[50%] translate-x-[50%] rounded-md min-w-[50%] text-center text-lg bg-blue-400 text-slate-50 text-shadow-[1px_1px_1px_#0000004a]`}>
            Ver ofertas
          </div>

          <h1 className='absolute top-[56%] right-1/2 translate-x-[50%] text-center min-w-full text-white font-bold text-shadow-[1px_1px_1px_#0000005a]'>
            Descubra lugares incríveis!
          </h1>

          <h2 className='absolute top-[62%] right-1/2 translate-x-[50%] text-center min-w-full text-white text-sm text-shadow-[0px_0px_1px_#0000006a]'>
        ...
        "h-[50px] bg-white shadow-[0_-8px_25px_rgba(0,0,0,0.18)]"
        }
        `}>

          <div className="w-full max-h-[60px] cursor-pointer flex justify-center items-start relative" onClick={() => setAdOpen(!adOpen)}>
          ...
          <div style={{padding: '6px 14px'}} className={`${adOpen && 'hidden'} absolute top-[5%] right-[6%] translate-x-[50%] rounded-md bg-amber-400 text-slate-800`}>
            40% off
          </div>
