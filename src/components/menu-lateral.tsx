...
export default function MenuLateral({ expandirMargem }: {expandirMargem: () => void}) {
    ...
    return (
        <aside className="menu-lateral menu-lateral-component">
            ...
            <article onClick={() => navigate('/viagens-romanticas')}  id="roteiro-automatico" className="itens-do-viajour-desktop menu-lateral-component">
            <a className="menu-lateral-component">
            ...
            <article onClick={() => navigate('/viagens-de-natal')} id="roteiro-automatico" className="itens-do-viajour-desktop menu-lateral-component">
            <a className="menu-lateral-component">
