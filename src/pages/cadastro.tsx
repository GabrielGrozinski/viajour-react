    ...
    <main className='cadastro-screen' id="imagem">
        <div className="form-container cadastro-screen">
            ...
            <form className="form cadastro-screen">
                <input type="email" className="input cadastro-screen" placeholder="Email" />
                <input type="password" className="input cadastro-screen" placeholder="Senha" />
                <a className="page-link-label cadastro-screen">Esqueci a senha</a>
                <button onClick={() => navigate('/principal')} className="form-btn cadastro-screen">Login</button>
            </form>
            <p className="sign-up-label cadastro-screen">
                Não tem uma conta?
                <span className="sign-up-link cadastro-screen">Se cadastrar</span>
            </p>
