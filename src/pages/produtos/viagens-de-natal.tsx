    ...
    <main id="container" className="pagina-natal viagens-natalinas-screen">
      ...
      <div className="lista-viagens viagens-natalinas-screen">
          ...
          >
            ...
            <div className="card-info viagens-natalinas-screen">
              <div className="viagens-natalinas-screen">
                <h2 className="card-titulo viagens-natalinas-screen">{v.destination}</h2>
                <p className="card-descricao viagens-natalinas-screen">{v.description}</p>
                <p className="card-custo viagens-natalinas-screen">
                  Custo estimado (7 dias):{" "}
                  <span className="viagens-natalinas-screen">{v.cost}</span>
                </p>
              </div>
        ...
        {itemsToShow.length < viagensFiltradas.length ? (
          ...
          <div className="loader-fim viagens-natalinas-screen">{loading ? <ClipLoader className='self-center' color='#000' loading size={35} /> : itemsToShow.length === 0 ? 'Nenhuma viagem encontrada' : 'Você chegou ao fim'}</div>
        )}
      </div>
    </main>
