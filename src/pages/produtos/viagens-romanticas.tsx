    ...
    <main id="container" className="pagina-natal viagens-romanticas-screen">
      ...
      <div className="lista-viagens viagens-romanticas-screen">
        ...
        {itemsToShow.length < viagensFiltradas.length ? (
          ...
          <div className="loader-fim viagens-romanticas-screen">{loading ? <ClipLoader className='self-center' color='#000' loading size={35} /> : itemsToShow.length === 0 ? 'Nenhuma viagem encontrada' : 'Você chegou ao fim'}</div>
        )}
      </div>
    </main>
