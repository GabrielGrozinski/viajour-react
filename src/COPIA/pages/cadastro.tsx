...
useEffect(() => {
    ...
    <main className='cadastro-screen' id="imagem">
        <div className="form-container">
            <p className="title">ViaJour</p>
            <form className="form">
            <input type="email" className="input" placeholder="Email" />
            <input type="password" className="input" placeholder="Senha" />
            <a className="page-link-label">Esqueci a senha</a>
            <button onClick={() => navigate('/principal')} className="form-btn">Login</button>
            </form>
            <p className="sign-up-label">
            Não tem uma conta?<span className="sign-up-link">Se cadastrar</span>
            </p>
